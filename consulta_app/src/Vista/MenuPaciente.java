...
public class MenuPaciente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mbar_procesos = new javax.swing.JMenu();
        mni_agregar = new javax.swing.JMenuItem();
        mni_listar = new javax.swing.JMenuItem();
        mni_salir = new javax.swing.JMenuItem();
        jMenu2 = new javax.swing.JMenu();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        mbar_procesos.setText("Procesos");
        ...
        mbar_procesos.add(mni_agregar);

        mni_listar.setText("Listar");
        mni_listar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mni_listarActionPerformed(evt);
            }
        });
        mbar_procesos.add(mni_listar);
        ...
        mbar_procesos.add(mni_salir);

        jMenuBar1.add(mbar_procesos);
    ...
    private void mni_listarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mni_listarActionPerformed
        ListarPaciente ag = new ListarPaciente ();
        ag.setVisible(true);
        this.dispose(); 
    }//GEN-LAST:event_mni_listarActionPerformed
    ...
    private javax.swing.JMenu mbar_procesos;
    private javax.swing.JMenuItem mni_agregar;
    private javax.swing.JMenuItem mni_listar;
